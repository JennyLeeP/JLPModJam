...
public class WorldGenSparklingTree extends WorldGenerator{
    ...
    public WorldGenSparklingTree(boolean par1)
    {
        this(par1, 15, 0, 0, true);
    }

    public WorldGenSparklingTree(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
            ...
            else
            {
                ...
                if (isSoil && par4 < 256 - l - 1)
                {
                    ...
                    for (j1 = 0; j1 < l; ++j1)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + j1, par5, ModBlocks.dreamLogs.blockID, this.metaWood);

...
public class WorldGenMinableDL extends WorldGenerator{
    ...
    public WorldGenMinableDL(int par1, int par2)
    {
        this(par1, par2, ModBlocks.dreamStone.blockID);
    }

    public WorldGenMinableDL(int par1, int par2, int par3)
    {
    ...
    public WorldGenMinableDL(int id, int meta, int number, int target)
    {

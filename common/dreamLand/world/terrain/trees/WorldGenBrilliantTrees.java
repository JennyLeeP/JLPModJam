...
public class WorldGenBrilliantTrees extends WorldGenerator{
     ...
     */
    static final short[] otherCoordPairs = new short[] {(short)2, (short)0, (short)0, (short)1, (short)2, (short)1};
    ...
    public WorldGenBrilliantTrees(boolean par1)
    {
        super(par1);
    }
    ...
    void genTreeLayer(int par1, int par2, int par3, float par4, short par5, int par6)
    {
        int i1 = (int)((double)par4 + 0.618D);
        short b1 = otherCoordPairs[par5];
        short b2 = otherCoordPairs[par5 + 3];
        ...
        for (aint1[par5] = aint[par5]; j1 <= i1; ++j1)
        {
            ...
            while (k1 <= i1)
            {
                ...
                else
                {
                    ...
                    {
                        this.setBlockAndMetadata(this.worldObj, aint1[0], aint1[1], aint1[2], par6, 2);
                        ++k1;
                    }
                }
            }
     ...
     float layerSize(int par1)
    {
     ...
     void generateLeafNode(int par1, int par2, int par3)
     {
         ...
         for (int i1 = par2 + this.leafDistanceLimit; l < i1; ++l)
         {
             ...
             this.genTreeLayer(par1, l, par3, f, (short)1, ModBlocks.dreamLeaves.blockID);
         }
     }
     ...
     * @param woodMetadata 
     ...
     void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, int par3)
     {
         ...
         if (aint2[b1] != 0)
         {
             short b2 = otherCoordPairs[b1];
             short b3 = otherCoordPairs[b1 + 3];
             short b4;
     ...
     void generateLeafNodeBases()
     {
         ...
         for (int[] aint = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; i < j; ++i)
         {
             ...
             {
                 this.placeBlockLine(aint, aint2, (short)ModBlocks.dreamLogs.blockID);
             }
         }
     }
     ...
     boolean validTreeLocation()
     {
         ...
         boolean isValidSoil = (soil != null && soil.canSustainPlant(worldObj, basePos[0], basePos[1] - 1, basePos[2], ForgeDirection.UP, (BlockDreamSaplings)ModBlocks.dreamSaplings));
         if (!isValidSoil)
         {
             return false;
         }

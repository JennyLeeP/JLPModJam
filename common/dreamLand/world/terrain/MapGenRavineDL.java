...
public class MapGenRavineDL extends MapGenBaseDL{
    ...
    protected void generateRavine(long par1, int par3, int par4, short[] blockIDArray, double par6, double par8, double par10, float par12, float par13, float par14, int par15, int par16, double par17)
    {
                                ...
                                if (d12 * d12 + d13 * d13 < 1.0D)
                                {
                                    for (int k4 = k2 - 1; k4 >= j2; --k4)
                                    {
                                        ...
                                        if ((d12 * d12 + d13 * d13) * (double)this.field_75046_d[k4] + d14 * d14 / 6.0D < 1.0D)
                                        {
                                            ...
                                            digBlock(blockIDArray, j4, j3, k2, k3, par3, par4, flag2);
                                        }

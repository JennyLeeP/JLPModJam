...
public class ChunkProviderDreamLand implements IChunkProvider {
    ...
    private MapGenCavesDL caveGenerator = new MapGenCavesDL();
    ...
    public Chunk provideChunk(int par1, int par2) {
        ...
        new MapGenCavesDL().generate(this, this.worldObj, par1, par2);
                    ...
                    for (int l1 = 0; l1 < 8; ++l1){
                        ...
                        for (int i2 = 0; i2 < 4; ++i2){
                            ...
                            for (int k2 = 0; k2 < 4; ++k2){
                                if ((d16 += d15) > 0.0D){
                                    idsTop[j2 += short1] = (short) ModBlocks.dreamStone.blockID;
                                }else if (((k1 * 8) + l1) < seaLevel){
                                    idsTop[j2 += short1] = (short) Block.waterStill.blockID;
                                }else{
                                    idsTop[j2 += short1] = 0;
                                }
                            }

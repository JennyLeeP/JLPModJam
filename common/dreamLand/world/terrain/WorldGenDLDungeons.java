...
public class WorldGenDLDungeons extends WorldGenerator{
                ...
                for (l1 = par4 + b0; l1 >= par4 - 1; --l1)
                {
                    for (i2 = par5 - i1 - 1; i2 <= par5 + i1 + 1; ++i2)
                    {
                        ...
                        else if (par1World.getBlockMaterial(k1, l1, i2).isSolid())
                        {
                            ...
                            {
                                par1World.setBlock(k1, l1, i2, ModBlocks.dreamStones.blockID, 0, 2);
                            }
                            else
                            {
                                par1World.setBlock(k1, l1, i2, ModBlocks.nmCobble.blockID, 0, 2);
                            }
                        }
                    }
                }

...
public class DreamLandTeleporter extends Teleporter {
     ...
     */
    @Override
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6,
            float par8) {
        short short1 = 128;
        double d3 = -1.0D;
        int i = 0;
        ...
        if (d3 >= 0.0D){
            if (flag){
                field_85191_c.add(j1, new DreamLandPortalPosition(this, i, j, k,
                        worldServerInstance.getTotalWorldTime()));
                field_85190_d.add(Long.valueOf(j1));
            }
                            ...
                            for (j3 = 0; j3 < 3; ++j3){
                                for (i4 = 0; i4 < 4; ++i4){
                                    for (l3 = -1; l3 < 4; ++l3){
                                        ...
                                        if (((l3 < 0) && !worldServerInstance.getBlockMaterial(k4,
                                                j4, l4).isSolid())
                                                || ((l3 >= 0) && !worldServerInstance.isAirBlock(
                                                        k4, j4, l4))){
                                            continue label274;
                                        }
                                    }
                            ...
                            for (i3 = l1; i3 < (l1 + 2); ++i3){
                                ...
                                for (j3 = 0; j3 < 4; ++j3){
                                    for (i4 = -1; i4 < 4; ++i4){
                                        ...
                                        if (((i4 < 0) && !worldServerInstance.getBlockMaterial(l3,
                                                k4, j4).isSolid())
                                                || ((i4 >= 0) && !worldServerInstance.isAirBlock(
                                                        l3, k4, j4))){
                                            continue label222;
                                        }
                                    }
            ...
            for (i3 = 0; i3 < 4; ++i3){
                for (l2 = -1; l2 < 4; ++l2){
                    ...
                    worldServerInstance.notifyBlocksOfNeighborChange(k3, j3, i4,
                            worldServerInstance.getBlockId(k3, j3, i4));
                }
            }
        }

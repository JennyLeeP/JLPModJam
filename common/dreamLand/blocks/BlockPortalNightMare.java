...
public class BlockPortalNightMare extends BlockPortal{
	public BlockPortalNightMare(int par1) {
        super(par1);
    ...
    public boolean tryToCreatePortal(World par1World, int par2, int par3, int par4) {
        ...
        if ((par1World.getBlockId(par2 - 1, par3, par4) == ModBlocks.nmCobble.blockID)
                || (par1World.getBlockId(par2 + 1, par3, par4) == ModBlocks.nmCobble.blockID)){
            b0 = 1;
        }

        if ((par1World.getBlockId(par2, par3, par4 - 1) == ModBlocks.nmCobble.blockID)
                || (par1World.getBlockId(par2, par3, par4 + 1) == ModBlocks.nmCobble.blockID)){
            b1 = 1;
        }
            ...
            for (l = -1; l <= 2; ++l){
                for (i1 = -1; i1 <= 3; ++i1){
                    ...
                    if (((l != -1) && (l != 2)) || ((i1 != -1) && (i1 != 3))){
                        ...
                        if (flag){
                            if (j1 != ModBlocks.nmCobble.blockID){
                                return false;
                            }
            ...
            for (l = 0; l < 2; ++l){
                for (i1 = 0; i1 < 3; ++i1){
                    par1World.setBlock(par2 + (b0 * l), par3 + i1, par4 + (b1 * l),
                            ModBlocks.nmPortal.blockID, 0, 2);
                }
            }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5) {
        ...
        if (par1World.getBlockId(par2, i1 - 1, par4) != ModBlocks.nmCobble.blockID){
            ...
            if ((j1 == 3)
                    && (par1World.getBlockId(par2, i1 + j1, par4) == ModBlocks.nmCobble.blockID)){
                ...
                if (flag && flag1){
                    ...
                    if (((par1World.getBlockId(par2 + b0, par3, par4 + b1) != ModBlocks.nmCobble.blockID) || (par1World
                            .getBlockId(par2 - b0, par3, par4 - b1) != blockID))
                            && ((par1World.getBlockId(par2 - b0, par3, par4 - b1) != ModBlocks.nmCobble.blockID) || (par1World
                                    .getBlockId(par2 + b0, par3, par4 + b1) != blockID))){
                        par1World.setBlockToAir(par2, par3, par4);
                    }
                }
        ...
        if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null)){
            ...
            if ((par5Entity.timeUntilPortal == 0) && (par5Entity instanceof EntityPlayerMP)){
                ...
                WorldServer worldserver1 = minecraftserver
                        .worldServerForDimension(Config.dimensionNMID);
                if (dimID == Config.dimensionNMID){
                    ((EntityPlayerMP) par5Entity).sendChatToPlayer("Moving");
                    minecraftserver.getConfigurationManager().transferPlayerToDimension(
                            (EntityPlayerMP) par5Entity, 0, new NightMareTeleporter(worldserver));
                }else{
                    ((EntityPlayerMP) par5Entity).sendChatToPlayer("Moving");
                    minecraftserver.getConfigurationManager().transferPlayerToDimension(
                            (EntityPlayerMP) par5Entity, Config.dimensionNMID,
                            new NightMareTeleporter(worldserver1));
                }
            }
        }
    }

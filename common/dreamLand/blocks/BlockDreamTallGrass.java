...
public class BlockDreamTallGrass extends BlockFlower implements IShearable{
	private static final String[] grassTypesDL = new String[] {"thornbush", "haygrass", "fern"};
    @SideOnly(Side.CLIENT)
    private Icon[] iconArray;

    protected BlockDreamTallGrass(int par1)
    {
    ...
    {
        this.iconArray = new Icon[grassTypesDL.length];

        for (int i = 0; i < this.iconArray.length; ++i)
        {
            this.iconArray[i] = par1IconRegister.registerIcon(grassTypesDL[i]);
        }
    }
